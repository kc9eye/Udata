...
$(document).ready(function(){
    var iconimg = "<img src='"+getAppRoot()+"/wwwroot/images/theme/thanksgivingicon.png' class='rounded float-right border border-dark' style='max-height:100px;max-width:150px;margin-top:-65px;' />";
    $('#template-header').css({
