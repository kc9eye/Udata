...
$(document).ready(function(){
    var iconimg = "<img src='"+getAppRoot()+"/wwwroot/images/theme/thanksgivingicon.png' class='rounded float-right border border-dark' style='max-height:75px;max-width:100px;margin-top:-70px;' />";
    $('#template-header').css({
