...
$config = [
    ...
    'dbpdo' => 'pgsql:host=localhost;port=5432;dbname=;sslmode=prefer',  #PDO database connection string 'dbdriver:host=mydbhost;port=mydbport;dbnam=mydbname;[sslmode=mydbencryption...]
